...
DELETE FROM CLIENTES WHERE CLI_CPF IN ('123.456.789-00', '987.654.321-00', '112.233.445-66', '223.344.556-77', '334.455.667-88');



-- Tabela FORNECEDORES

DELETE FROM FORNECEDORES WHERE FORN_CNPJ IN ('12.345.678/0001-00', '23.456.789/0001-11', '34.567.890/0001-22', '45.678.901/0001-33', '56.789.012/0001-44');



-- Tabela PRODUTOS

DELETE FROM PRODUTOS WHERE PROD_ID IN (1, 2, 3, 4, 5);



-- Tabela PRODUTOS_FORNECEDORES

DELETE FROM PRODUTOS_FORNECEDORES WHERE PROD_ID IN (1, 2, 3, 4, 5) AND FORN_CNPJ IN ('12.345.678/0001-00', '45.678.901/0001-33', '23.456.789/0001-11', '34.567.890/0001-22', '56.789.012/0001-44');
...
DELETE FROM VENDAS WHERE VENDA_ID IN (1, 2, 3, 4, 5);



-- Tabela VENDAS_PRODUTOS

DELETE FROM VENDAS_PRODUTOS WHERE VENDA_ID IN (1, 2, 3, 4, 5) AND PROD_ID IN (1, 2, 3, 4, 5);
